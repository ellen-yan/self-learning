...
# Assignment 3, Parts 1 and 2 of 3
# Python 2.7.10
#
...
# Note: Works, but uses recursive method, exceeds recursion limit for purposes
# of this assignment.
...
def huffman_encode(weight_dict, weight_heap, symbol_dict):
    ...
    if len(weight_heap) <= 1:
        return # end recursion if we combined the last two items in heap
